...
//    public static final Item joja_cola = null;
//
//    @SubscribeEvent
//    public static void registerItems(final RegistryEvent.Register<Item> event) {
//        // for custom creative tab, do this: .group(TrailMix.TrailMixItemGroup.instance)
//        event.getRegistry().register(new Item(new Item.Properties().group(ItemGroup.FOOD).food(new Food.Builder().hunger(15).saturation(6.0F).build())).setRegistryName("baguette"));
